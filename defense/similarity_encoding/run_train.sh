#python train.py --ckpt_suffix=.cifar10_feat --load_pretrained=0 --margin=10
#python train.py --ckpt_suffix=.cifar10_feat --load_pretrained=1 --margin=100
#python train.py --ckpt_suffix=.cifar10_feat --load_pretrained=1 --margin=1000
...
CUDA_VISIBLE_DEVICES=1 python train.py --load_pretrained --ckp_dir=/mydata/model-extraction/model-extraction-defense/attack/victim/models/cifar10/wrn28/ --model_name=wrn28 --sim_epochs=10 --margin=10