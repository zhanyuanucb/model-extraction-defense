...
def main():
    ...
    samples = datasets.__dict__[dataset_name](train=True, transform=transform)

    # TODO: train/validation splitting
    trainset = PositiveNegativeSet(samples, normal_transform=transform, random_transform=random_transform)
    train_loader = DataLoader(trainset, batch_size=1, shuffle=True, num_worker=10)
