...
CUDA_VISIBLE_DEVICES=1 python train.py CIFAR10 wrn28 -o /mydata/model-extraction/model-extraction-defense/attack/victim/models/cifar10/wrn28 -b 256 -e 120 --lr 0.01 --log-interval 10 --device_id=1
...
#python train.py CINIC10 wrn40 -o /mydata/model-extraction/model-extraction-defense/attack/adversary/query_blinding/f_cinic -b 128 -e 50 --lr 0.01 --num_classes 10 --log-interval 100